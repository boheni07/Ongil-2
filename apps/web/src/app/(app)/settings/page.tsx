...
/**
 * 설정 인덱스 — 사이드바 "설정"(보호자·지원사 등)의 진입점. 프로필 수정(GlobalHeader
 * 사용자 메뉴에서도 진입 가능)·개인정보·동의 관리(G-65/P-23) 두 항목을 연결한다.
 * 항목이 늘어나면 이 목록에 추가한다.
 */
        ...
        <li>
          ...
          >
            <span className="flex flex-col">
              <span className="text-body font-semibold text-foreground">프로필 수정</span>
              <span className="mt-0.5 text-caption text-muted-foreground">이름, 프로필 사진 변경</span>
            </span>
